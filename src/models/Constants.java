...
public class Constants {
	...
	public static final int SERVER_PORT = 2660;
	
	public static final String WAITING = "Waiting for client connection...";
	public static final String CONNECT_TO_SERVER = "Exception while accepting the connection to a client";
	...
	public static final String CONNECT_TO_CLIENT = "Exception while accepting the connection to a server";
}
